...
class RecycleGANModel(BaseModel):
    ...
    def backward_D_A(self):
        ...
        self.loss_D_A = loss_D_A0.data[0] + loss_D_A1.data[0] + \
            loss_D_A2.data[0] + loss_D_A3.data[0]
    ...
    def backward_D_B(self):
        ...
        self.loss_D_B = loss_D_B0.data[0] + loss_D_B1.data[0] + \
            loss_D_B2.data[0] + loss_D_B3.data[0]
    ...
    def backward_G(self):
        ...
        self.loss_G_A = loss_G_A0.data[0] + \
            loss_G_A1.data[0] + loss_G_A2.data[0]
        self.loss_G_B = loss_G_B0.data[0] + \
            loss_G_B1.data[0] + loss_G_B2.data[0]
